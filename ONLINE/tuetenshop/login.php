...
/*###################################################################################################################################################################################################################################################################################*/
    ...
    if(isset($_POST['registrieren']))
    {
        ...
        {
            $erg = registrieren($_POST['email_registrieren'], $_POST['passwort_registrieren'], $_POST['vorname_registrieren'], $_POST['nachname_registrieren'], $_POST['straße_registrieren'], $_POST['hausnummer_registrieren'], $_POST['ort_registrieren'], $_POST['postleitzahl_registrieren']); /*??? vllt falsche variablen?*/
            echo('<p>'. $erg . '</p>');
        }
    }
    else
